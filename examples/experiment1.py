...
# Author: Tamanna
# Generated: Tue Mar 19 01:22:12 2019
##################################################
...
class experiment1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Virtualization")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Virtualization")
        ...
        self.settings = Qt.QSettings("GNU Radio", "experiment1")
        ...
        self.connect((self.timesvl_TimeSVL_0, 0), (self.blocks_throttle_0, 0))
...
def main(top_block_cls=experiment1, options=None):
