...
# Title: Experiment4 Rx
# Generated: Tue Mar 19 16:27:04 2019
##################################################
...
class experiment4_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Experiment4 Rx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Experiment4 Rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "experiment4_rx")
...
def main(top_block_cls=experiment4_rx, options=None):
