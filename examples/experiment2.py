...
class experiment2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.timesvl_TimeSVL_2_0 = timesvl.TimeSVL(gr.sizeof_gr_complex*1, 1, '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Time_maps/output_time_map2_1.txt', '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Input_Output parameters/output_2_1.txt')
        self.timesvl_TimeSVL_2 = timesvl.TimeSVL(gr.sizeof_gr_complex*1, 1, '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Time_maps/output_time_map2_2.txt', '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Input_Output parameters/output_2_2.txt')
        self.timesvl_TimeSVL_1 = timesvl.TimeSVL(gr.sizeof_gr_complex*1, 1, '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Time_maps/input_time_map2_2.txt', '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Input_Output parameters/input_2_2.txt')
        self.timesvl_TimeSVL_0 = timesvl.TimeSVL(gr.sizeof_gr_complex*1, 1, '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Time_maps/input_time_map2_1.txt', '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Input_Output parameters/input_2_1.txt')
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_0_win, 2, 0, 1, 8)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_win, 1, 0, 1, 7)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_2_win, 3, 0, 1, 8)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_win, 1, 7, 1, 1)
        [self.top_grid_layout.setRowStretch(r,1) for r in range(1,2)]
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_win, 0, 0, 1, 4)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_win, 0, 4, 1, 3)
        [self.top_grid_layout.setRowStretch(r,1) for r in range(0,1)]
        ...
        self.blocks_file_source_0_1 = blocks.file_source(gr.sizeof_char*1, '/media/tamanna/Seagate Expansion Drive/TCD 2018-2019/4E2 Final year project/gr-mysvl/examples/inputs/Memory_and_Forgetting.mp3', True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/media/tamanna/Seagate Expansion Drive/TCD 2018-2019/4E2 Final year project/gr-mysvl/examples/inputs/Memory_and_Forgetting.mp3', True)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/outputs/output_audio1.mp3', False)
        self.blocks_file_sink_0_0.set_unbuffered(True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/outputs/output_audio2.mp3', False)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.analog_const_source_x_0, 0), (self.timesvl_TimeSVL_0, 1))
        ...
        self.connect((self.blocks_file_source_0_1, 0), (self.blks2_packet_encoder_1, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.timesvl_TimeSVL_1, 1))
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.digital_ofdm_tx_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        ...
        self.connect((self.timesvl_TimeSVL_2, 1), (self.digital_gmsk_demod_0, 0))
        self.connect((self.timesvl_TimeSVL_2, 0), (self.timesvl_TimeSVL_2_0, 0))
        self.connect((self.timesvl_TimeSVL_2_0, 1), (self.blocks_null_sink_0, 0))
        self.connect((self.timesvl_TimeSVL_2_0, 0), (self.digital_ofdm_rx_0, 0))
