...
# Title: Usrp Experiment2 Rx
# Generated: Thu Mar 21 15:55:06 2019
##################################################
...
class usrp_experiment2_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Usrp Experiment2 Rx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Usrp Experiment2 Rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_experiment2_rx")
        ...
        self.timesvl_TimeSVL_0 = timesvl.TimeSVL(gr.sizeof_gr_complex*1, 1, '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Time_maps/output_time_map1.txt', '/media/tamanna/Seagate Expansion Drive/gr-timesvl/examples/Input_Output parameters/output_1.txt')
        ...
        self.qtgui_time_sink_x_1_0.set_y_axis(-0.2, 2)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_win, 3, 1, 1, 2)
        ...
        [self.top_grid_layout.setRowStretch(r,1) for r in range(2,3)]
        [self.top_grid_layout.setColumnStretch(c,1) for c in range(0,1)]
        self.mysvl_triggered_demux_0 = mysvl.triggered_demux(gr.sizeof_gr_complex*1, gr.sizeof_float, (preamble_len+padding,packet_len,padding), 1, True)
        ...
        self.connect((self.blocks_complex_to_float_0_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.blocks_complex_to_float_0_0, 1), (self.qtgui_time_sink_x_1_0, 1))
        ...
        self.connect((self.digital_corr_est_cc_0, 0), (self.blocks_complex_to_float_0_0, 0))
        ...
        self.connect((self.mysvl_triggered_demux_0, 2), (self.blocks_null_sink_1_0, 0))
        self.connect((self.mysvl_triggered_demux_0, 1), (self.timesvl_TimeSVL_0, 0))
        ...
        self.connect((self.timesvl_TimeSVL_0, 1), (self.rational_resampler_xxx_0, 0))
        self.connect((self.timesvl_TimeSVL_0, 0), (self.rational_resampler_xxx_0_0, 0))
...
def main(top_block_cls=usrp_experiment2_rx, options=None):
